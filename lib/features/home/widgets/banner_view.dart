                          ...
                          Expanded(
                            child: CarouselSlider.builder(
                              options: CarouselOptions(
                                autoPlay: bannerController.bannerDataList?.length==1?false
                                    :true,
                                enlargeCenterPage: true,
                                disableCenter: true,
                                viewportFraction: 1.0,
                                // Set viewportFraction to 1.0 to use the full width
                          ...
                          Row(
                            ...
                            children: bannerList.map((bnr) {
                              ...
                              return Padding(
                                ...
                                child: Container(
                                  height: 8, // Keeping all dots the same size
                                  width: 8,
                                  decoration: BoxDecoration(
                                    color: index ==
                                        ...
                                        ? const Color(0xFF181a1f)
                                            .withOpacity(0.3)
                                        // Darker color for the current index
                                        : const Color(0xFFf0f2f5),
                                    // Lighter color for other indices
                                    borderRadius: BorderRadius.circular(
                                        50), // Circular shape
                                  ),
                                ),
